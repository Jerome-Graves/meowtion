...
\begin{table}[ht]
  ...
  \begin{tabularx}{\textwidth}{@{}l X l@{}}
    ...
    NFR-1 & \textbf{Power.} The collar must run for a useful time on a collar-sized cell, which
            precludes Wi-Fi on the wearable, bounds the duty cycle of the audio path, and is met
            chiefly by the rules-based activity gate that rests the collar between bouts of motion. &
            \cref{sec:hardware,sec:on-device-ai,sec:firmware-collar} \\
