...
This section states the requirements the system was designed to meet and the constraints that shaped
the design, so the chapters that follow can be read as the response to them. The final column of each
table points to the section where the requirement is addressed.
...
\Cref{tab:nfr} lists the quality attributes and limits the design has to meet, the constraints behind
many of the engineering choices in the chapters that follow.
...
These requirements and constraints are referenced again in \cref{sec:evaluation}, which reports the
extent to which each is currently met.
